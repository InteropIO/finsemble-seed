...
(function (definition) {
	...
	/**
	 * Turns on a menu and disables touch and mouse events. Typically managed automatically but can be called programmatically.
	 ...
	 *
	 * See the following tutorial if you wish to programmatically create **custom color themes**: {@tutorial Custom Color Themes}
	 *
	 * @namespace
	...
	*/
	 ...
	 * @param  {object} div The DOM element that is the study dialog
	 * @param  {CIQ.ChartEngine} stx A chart object
	 * @return {object}     The study descriptor is returned. This can be used in the future for deleting the study programmatically.
	 * @memberOf CIQ.Studies
	 */
