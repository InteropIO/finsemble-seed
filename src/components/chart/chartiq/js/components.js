...
<cq-lookup cq-keystroke-claim cq-keystroke-default>
	 ...
	 * @param {number} multiplier   The multiplier that will be passed to {@link CIQ.ChartEngine#setSpan}
	 * @param {string} base The base that will be passed to {@link CIQ.ChartEngine#setSpan}
	 * @param {number} [interval] The interval that will be passed to {@link CIQ.ChartEngine#setSpan}. Leave empty for autodetect.
	 * @param {number} [period] The period that will be passed to {@link CIQ.ChartEngine#setSpan}. Leave empty for autodetect.
	 * @param {string} [timeUnit] The timeUnit that will be passed to {@link CIQ.ChartEngine#setSpan}. Leave empty for autodetect.
	 * @alias set
