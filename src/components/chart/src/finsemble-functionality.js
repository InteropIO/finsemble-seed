...
window.onAfterChartCreated = function () {
	...
	console.log("Symbol is here", spawnData.hasOwnProperty('symbol'));
	if(spawnData.hasOwnProperty('symbol') ){
		let symbol = spawnData.symbol;
...
window.changeSymbol = function (data) {
	...
	// });
	console.log("WHY AM I FAILING!", JSON.stringify(data));
