/*!
 * Skypack CDN - pikaday@1.8.2
 *
 * Learn more:
 *   📙 Package Documentation: https://www.skypack.dev/view/pikaday
 *   📘 Skypack Documentation: https://www.skypack.dev/docs
 *
 * Pinned URL: (Optimized for Production)
 *   ▶️ Normal: https://cdn.skypack.dev/pin/pikaday@v1.8.2-XZpoitjGl5Nd11SfknUA/mode=imports/optimized/pikaday.js
 *   ⏩ Minified: https://cdn.skypack.dev/pin/pikaday@v1.8.2-XZpoitjGl5Nd11SfknUA/mode=imports,min/optimized/pikaday.js
 *
 * This file has been cached from the normal pinned URL.
 */
...
var pikaday = createCommonjsModule(function(module, exports) {
  ...
  (function(root, factory) {
    ...
    var hasMoment = typeof moment2 === "function", hasEventListeners = !!window.addEventListener, document = window.document, sto = window.setTimeout, addEvent = function(el, e, callback, capture) {
