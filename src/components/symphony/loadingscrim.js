...
<div id="finsemble-loading-scrim" class="fin-dots" style="background: black; position: fixed; top:-32px; left:0; height:calc(100vh + 32px); width:100vw; z-index: 2147483647; display: flex; align-items: center; justify-content: center;">
...
`;
	...
	window.removeFinsembleLoadingScrim = function () {
