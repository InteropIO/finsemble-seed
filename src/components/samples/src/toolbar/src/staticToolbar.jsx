	...
	render() {
		return (<FinsembleToolbar>
			<FinsembleToolbarSection name="left" className="left">
				<FinsembleButton preSpawn={true} buttonType={["MenuLauncher", "Toolbar"]} iconClasses="finsemble-toolbar-brand-logo" icon="http://localhost:3375/components/samples/src/assets/img/Finsemble_Taskbar_Icon.png" menuType="File Menu" />
