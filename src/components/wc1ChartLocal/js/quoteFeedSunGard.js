...
(function (definition) {
	...
	// TODO add in Muse and SignalR dependencies to UMD header
	if (typeof exports === "object" && typeof module === "object") {
		module.exports = definition( require('./chartiq'), require('./symbolLookup.js') );
	} else if (typeof define === "function" && define.amd) {
		define(["chartiq","symbolLookup"], definition);
	...
	quoteFeedSunGard.loadDependencies=function(tryLater){
		if(typeof(muse)!="object" && !this.loadingDependencies){
			...
			var dependencies=[
				...
				'https://tbd3.marketmapmuse.com/MuseJS/muse.min.js'
						...
						if(!stx.isHistoricalMode()) {
							translateAndSendToChart(data, symbol, function(quotes) {
								...
								if(qts && qts.length) {
									...
									stx.quoteDriver.executeTagAlongs(params);
