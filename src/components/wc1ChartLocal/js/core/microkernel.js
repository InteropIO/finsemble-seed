...
(function(_exports){
	...
	CIQ.ChartEngine.prototype.swipeRelease=function(){
		 ...
		 *
		 * Example <iframe width="100%" height="500" scrolling="no" seamless="seamless" align="top" style="float:top" src="http://jsfiddle.net/chartiq/ouh4k95z/embedded/result,js,html/" allowfullscreen="allowfullscreen" frameborder="1"></iframe>
		 *
