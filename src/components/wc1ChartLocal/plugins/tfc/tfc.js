...
CIQ.TFC.prototype.updateValues=function(){
	...
	if(this.activeTrade=="market"){
		...
		if(this.elements.dragLineCenterPrice.innerValue!=="") price=this.quantityFromValue(this.elements.dragLineCenterPrice.innerValue);
		if(this.activeInput=="shares"){
 ...
 * TBD added internationalize argument
 */
