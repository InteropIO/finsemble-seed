...
(function (definition) {
	 ...
	 * @since 6.1.0
	 * @since TBD added bidBaseColor and askBaseColor parameters to replace baseColor.
	 *
	 * @example
	 ...
	 * This template can also be used as reference to create your oun UI for this module.
	 *
