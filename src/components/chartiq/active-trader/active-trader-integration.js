...
//! The data simulator currently ony returns data for forex symbols
//    As we only care about the data we'll just slick through different
//    forex symbols to retrieve dummy data
