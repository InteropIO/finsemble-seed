...
(function (definition) {
    ...
    if (typeof exports === "object" && typeof module === "object") {
        module.exports = definition(require('./utility'));
    } else if (typeof define === "function" && define.amd) {
        define(['core/utility'], definition);
    } else if (typeof window !== "undefined" || typeof self !== "undefined") {
		var global = typeof window !== "undefined" ? window : self;
		definition(global);
    } else {
		throw new Error("Only CommonJS, RequireJS, and <script> tags supported for timezone.js.");
    }

})(function(_exports) {
	var CIQ=_exports.CIQ;
	console.log("timezone.js",_exports);
	...
	CIQ.timeZoneMap={
			...
			"(UTC-03:00) Buenos Aires, Santiago":"America/Argentina/Buenos_Aires",
			...
			"(UTC) Casablanca, Dublin, Lisbon, London":"Europe/London",
			"(UTC) Greenwich Mean Time, Reykjavik":"Atlantic/Reykjavik",
			...
			"(UTC+03:00) Baghdad, Kuwait, Riyadh":"Asia/Kuwait",
			...
			"(UTC+04:00) Astrakhan, Samara, Ulyanovsk":"Europe/Samara",
			...
			"(UTC+12:00) Auckland, Wellington, Fiji":"Pacific/Auckland",
	...
	_exports.timezoneJS.timezone.loadZoneDataFromObject(
			{
				"zones" : {
					...
					"Asia/Pyongyang" : [ [ -540, "-", "KST", 1439596800000 ],
							[ -510, "-", "KST", null ] ],
					...
					"Pacific/Tongatapu" : [ [ -780, "Tonga", "TO%sT", null ] ],
					...
					"Europe/Kaliningrad" : [ [ -180, "-", "+03", 1414288800000 ],
							[ -120, "-", "EET", null ] ],
					"Europe/Moscow" : [ [ -240, "-", "MSK", 1414288800000 ],
							[ -180, "-", "MSK", null ] ],
					"Europe/Simferopol" : [ [ -120, "EU", "EE%sT", 1396144800000 ],
							[ -240, "-", "MSK", 1414288800000 ], [ -180, "-", "MSK", null ] ],
					"Europe/Samara" : [ [ -240, "-", "+04", null ] ],
					"Asia/Yekaterinburg" : [ [ -360, "-", "+06", 1414288800000 ],
							[ -300, "-", "+05", null ] ],
					"Asia/Novosibirsk" : [ [ -420, "-", "+07", 1414288800000 ],
							[ -360, "-", "+06", 1469325600000 ], [ -420, "-", "+07", null ] ],
					"Asia/Krasnoyarsk" : [ [ -480, "-", "+08", 1414288800000 ],
							[ -420, "-", "+07", null ] ],
					"Asia/Irkutsk" : [ [ -540, "-", "+09", 1414288800000 ],
							[ -480, "-", "+08", null ] ],
					"Asia/Yakutsk" : [ [ -600, "-", "+10", 1414288800000 ],
							[ -540, "-", "+09", null ] ],
					"Asia/Vladivostok" : [ [ -660, "-", "+11", 1414288800000 ],
							[ -600, "-", "+10", null ] ],
					"Asia/Magadan" : [ [ -720, "-", "+12", 1414288800000 ],
							[ -600, "-", "+10", 1461463200000 ], [ -660, "-", "+11", null ] ],
					"Asia/Srednekolymsk" : [ [ -720, "-", "+12", 1414288800000 ],
							[ -660, "-", "+11", null ] ],
					"Asia/Kamchatka" : [ [ -720, "-", "+12", null ] ],
					"Europe/Belgrade" : [ [ -60, "EU", "CE%sT", null ] ],
					"Europe/Sarajevo" : "Europe/Belgrade",
					"Europe/Istanbul" : [ [ -120, "EU", "EE%sT", 1396141200000 ],
					...
					"America/St_Johns" : [ [ 210, "StJohns", "N%sT", 1320105600000 ],
							[ 210, "Canada", "N%sT", null ] ],
					...
					"America/Caracas" : [ [ 270, "-", "VET", 1462069800000 ],
							[ 240, "-", "VET", null ] ]
				},
				"rules" : {
					"Egypt" : [
					...
					"Zion" : [
							...
							[ 2012, "only", "-", "Mar", "Fri>=26", [ 2, 0, 0, null ], 60,
									"D" ],
							[ 2012, "only", "-", "Sep", "23", [ 2, 0, 0, null ], 0, "S" ],
							[ 2013, "max", "-", "Mar", "Fri>=23", [ 2, 0, 0, null ], 60,
									"D" ],
							[ 2013, "max", "-", "Oct", "lastSun", [ 2, 0, 0, null ], 0, "S" ] ],
					"Japan" : [],
					"ROK" : [],
					"Mongol" : [
							[ 2015, "max", "-", "Mar", "lastSat", [ 2, 0, 0, null ], 60,
									"S" ],
					...
					"Canada" : [
							[ 2007, "max", "-", "Mar", "Sun>=8", [ 2, 0, 0, null ], 60, "D" ],
							[ 2007, "max", "-", "Nov", "Sun>=1", [ 2, 0, 0, null ], 0, "S" ] ],
					"StJohns" : [ [ 2007, 2011, "-", "Mar", "Sun>=8", [ 0, 1, 0, null ],
							60, "D" ] ],
					"Mexico" : [
					...
					"Arg" : [],
					"Brazil" : [
							[ 2008, "max", "-", "Oct", "Sun>=15", [ 0, 0, 0, null ], 60,
									"S" ],
	...
	CIQ.convertTimeZone=function(dt, originalTimeZone, targetTimeZone){
		...
		var newDT=new _exports.timezoneJS.Date(dt.getFullYear(), dt.getMonth(), dt.getDate(), dt.getHours(), dt.getMinutes(), dt.getSeconds(), dt.getMilliseconds(), originalTimeZone);
	...
	CIQ.convertToLocalTime=function(dt, originalTimeZone){
		...
		var newDT=new _exports.timezoneJS.Date(dt.getFullYear(), dt.getMonth(), dt.getDate(), dt.getHours(), dt.getMinutes(), originalTimeZone);
