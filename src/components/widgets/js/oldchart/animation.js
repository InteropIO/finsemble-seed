...
(function (definition) {
	...
	var scrollAnimator = new CIQ.EaseMachine(Math.easeInOutCubic, 5000);

	CIQ.ChartEngine.prototype.prepend("renderYAxis", function(chart){
		//if(!this.grabbingScreen) return; // <--- We only really need this logic when scrolling back and forth
