...
import { SystemTrayComponentWrapper, Preferences, SystemLog, CentralLogger, Documentation, Restart, Reset, Quit } from "@chartiq/finsemble-ui/react/components";

/**
 * This component will be rendered whenever the user right clicks on your application's system tray icon.
 * Feel free to add/remove anything in here. The SystemTrayComponentWrapper handles setting the height/width
 * of the window. It will also hide the window when it loses focus.
 */
const SystemTrayComponent = () => {
    return (
        <SystemTrayComponentWrapper padding={{width: 80}}>
