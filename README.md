...
The recommended version is [v10.0.3 release](https://github.com/InteropIO/iocd-components/releases?q=v10.0.3&expanded=true).
...
> Note: Your build process must perform the steps in the [Installing](#installing) section above before it can create a deployable installer.

Run `yarn makeInstaller-iocd`

_Use `-- --skip-install` if you do not wish to download iocd again_
