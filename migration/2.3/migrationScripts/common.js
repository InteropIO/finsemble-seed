...
module.exports.copy = function copy(params, cb) {
    ...
    if (COPYING_NODE_MODULES) {
        module.exports.log("Copying node modules. This may take several minutes. The operation is blocking, so we cannot periodically let you know that the script is still working. Give it time.");
    }
