		...
		return (
			<FinsembleMenu padding={padding}>
				...
				<FinsembleMenuSection className="menu-primary">
					<FinsembleMenuItem
						label="Preferences"
						onClick={FileMenuActions.spawnPreferences}
					/>
					<FinsembleMenuItem
						label="System Log"
						onClick={FileMenuActions.showSystemLog}
					/>
					<FinsembleMenuItem
						label="Central Logger"
						onClick={FileMenuActions.showCentralConsole}
					/>
					<FinsembleMenuItem
						label="Documentation"
						onClick={FileMenuActions.spawnDocs}
					/>
					{window.location.toString().includes("localhost") ? (
						<FinsembleMenuItem
							label="Restart"
							onClick={FileMenuActions.restart}
						/>
					) : null}
					{window.location.toString().includes("localhost") ? (
						<FinsembleMenuItem
					...
					<FinsembleMenuItem
						label="Quit"
						onClick={FileMenuActions.shutdownApplication}
					/>
				</FinsembleMenuSection>
			</FinsembleMenu>
		);
