    ...
    renderTitle() {
        return (<div
            ...
            onDragStart={(e) => {
                ...
                console.log(" Actions.getWindowIdentifier()", Actions.getWindowIdentifier())
