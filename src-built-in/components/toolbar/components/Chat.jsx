...
export default class Chat extends React.Component {
	...
	componentWillMount() {
		let self = this;
		FSBL.Clients.RouterClient.subscribe("chatService-unreadCount", function(
			err,
			response
		) {
		...
		FSBL.Clients.RouterClient.addListener("ChatService.OpenMainChat", function(
			err,
			response
		) {});
		FSBL.Clients.RouterClient.addListener("ChatService.loseMainChat", function(
			err,
			response
		) {});
	}
