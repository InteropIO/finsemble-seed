...
export default class WorkspaceMenuOpener extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			workspaceMenuWindowName: ToolbarStore.Store.getValue(
				"workspaceMenuWindowName"
			),
	...
	bindCorrectContext() {
		this.receiveActiveWorkspaceName = this.receiveActiveWorkspaceName.bind(
			this
		);
		this.receiveWorkspaceMenuWindowName = this.receiveWorkspaceMenuWindowName.bind(
			this
		);
	...
	render() {
		...
		return (
			<FinsembleButton
				...
				className={
					"finsemble-toolbar-workspace-button-label workspace-menu-button"
				}
